...
for match_ID in match_IDs:
    ...
    column_names = ["team1_rounds_won", "team2_rounds_won",
                "team1_players_alive", "team2_players_alive",
                "team1_cash", "team2_cash",
                "team1_cash_spent", "team2_cash_spent",
                "team1_equipment_value", "team2_equipment_value",
                "team1_kill_times", "team2_kill_times"]
                            
    match_df = pd.DataFrame(np.array([team1_rounds_won, team2_rounds_won,
                            team1_players_alive, team2_players_alive,
                            team1_cash, team2_cash,
                            team1_cash_spent, team2_cash_spent,
                            team1_equipment_value, team2_equipment_value,
                            team1_kill_times, team2_kill_times]).transpose(),
    ...
    match_df["team2_kill_times"] = team2_kill_times[:second_pistol_rnd-1] + team1_kill_times[second_pistol_rnd-1:]
